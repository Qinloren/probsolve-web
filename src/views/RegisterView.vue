  ...
  <div class="register-container">
    <div class="register-form-card">
      ...
      <div class="register-form-card-form">
        <a-form layout="vertical" :model="data.registerForm" :rules="data.registerForm.rules" ref="registerForm">
          ...
          <a-form-item>
            <a-button type="primary" size="large" class="register-btn" @click="submitRegister">
              注册
            </a-button>
          </a-form-item>
